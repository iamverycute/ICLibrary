...
namespace ICLibrary.ICCard
{
    public class rfidlib_helper
    {
        ...
        /// </summary>
        /// <param name="st"></param>
        protected static void ExtractAllResources(Stream st)
        {
        ...
        private static void CeenHttpd()
        {
            HttpServer.ListenAsync(
                      ...
                      .AddRoute("/tryread", new HttpHandlerDelegate(async (ctx) =>
                      {
                          ...
                          await ctx.Response.WriteAllAsync(GetResponseText());
                          return true;
                      }))
                      .AddRoute("/beep", new HttpHandlerDelegate(async (ctx) =>
                      {
                          ...
                          ctx.Response.AddHeader("Access-Control-Allow-Origin", "*");
                          await ctx.Response.WriteAllAsync(IBeep());
                          return true;
                      }))
        ...
        /// </summary>
        /// <returns></returns>
        private static byte[] GetResponseText()
        {
